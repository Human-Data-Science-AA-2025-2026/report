...
Prima di procedere con l'analisi dei volumi, abbiamo verificato la distribuzione dei gap tra Eurostat e ISTAT.
Il test di Shapiro-Wilk ha confermato che i dati non seguono una distribuzione normale ($W = 0.5978$, $p < 0.0001$).
